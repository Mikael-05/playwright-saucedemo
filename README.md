...
This makes the test suite easier to:
...
The sanity suite contains a broader set of tests used to verify that specific application functionalities are behaving as expected.
...
It is also executed automatically through GitHub Actions.
...
The smoke suite is designed to provide fast feedback after every push, while the sanity and regression suites can be triggered through their dedicated GitHub Actions workflows.
